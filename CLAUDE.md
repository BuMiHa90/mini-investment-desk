...
This repository is run automatically by Windows Task Scheduler through Claude CLI. When the scheduled prompt says to follow `CLAUDE.md`, run the daily desk workflow below exactly.
